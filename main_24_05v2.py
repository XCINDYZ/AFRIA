    ...
    for behaviour in problematic_behaviour_list:
      ...
      if additional_info:
        ...
        HR = openai.chat.completions.create(
            ...
            messages =[
            {"role": "assistant", 
            "content": f"What human rights and freedoms of the stakeholder '{stakeholder}' are affected by this harm: {harm}. Refrain from mentioning human rights and freedoms of other stakeholders, but only focus on the human rights and freedoms of {stakeholder}."}
          ],
            max_tokens = 300
        )
